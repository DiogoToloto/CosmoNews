    ...
    <div>
      ...
      <p>
        <span style={{color: rgb(68, 68, 68)}}>
          A sua privacidade é importante para nós. É política do CosmoNews
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site{" "}
          <a href="https://cosmo-news-red.vercel.app/">CosmoNews</a>, e outros
      ...
      <p>
        <span style="color: rgb(68, 68, 68);">
          ...
          informação que o CosmoNews oferece no site e com caráter enunciativo,
          mas não limitativo:
        </span>
      </p>
      <ul>
        ...
        <li>
          <span style="color: rgb(68, 68, 68);">
            ...
            (softwares) do CosmoNews, de seus fornecedores ou terceiros, para
      ...
      <p>
        <span style="color: rgb(68, 68, 68);">
          Esta política é efetiva a partir de&nbsp;21 June 2025 03:12
        </span>
      </p>
    </div>
  );
